...
class FasterRCNNInceptionV2FeatureExtractor(
  ...
  def _extract_proposal_features(self, preprocessed_inputs, scope):
    ...
    encoder_1_conv = slim.conv2d(
                  preprocessed_inputs, depth(64), [3, 3],
      ...
      with slim.arg_scope(
        ...
        with _batch_norm_arg_scope([slim.conv2d, slim.separable_conv2d],
          ...
          with tf.variable_scope('Mixed_5a'):
            with tf.variable_scope('Branch_0'):
              branch_0 = slim.conv2d(
                  ...
                  weights_initializer=trunc_normal(0.09),
                  scope='Conv2d_0a_1x1')
              branch_0 = slim.conv2d(branch_0, depth(48), [3, 3], stride=2,
                                     scope='Conv2d_1a_3x3')
            with tf.variable_scope('Branch_1'):
              ...
              branch_1 = slim.conv2d(branch_1, depth(64), [3, 3],
                                     scope='Conv2d_0b_3x3')
              branch_1 = slim.conv2d(branch_1, depth(64), [3, 3], stride=2,
                                     scope='Conv2d_1a_3x3')
          ...
          with tf.variable_scope('Mixed_5b'):
            with tf.variable_scope('Branch_0'):
              branch_0 = slim.conv2d(net, depth(88), [1, 1],
                                     scope='Conv2d_0a_1x1')
            with tf.variable_scope('Branch_1'):
              branch_1 = slim.conv2d(
                  net, depth(48), [1, 1],
                  weights_initializer=trunc_normal(0.09),
                  scope='Conv2d_0a_1x1')
              branch_1 = slim.conv2d(branch_1, depth(80), [3, 3],
                                     scope='Conv2d_0b_3x3')
            with tf.variable_scope('Branch_2'):
              branch_2 = slim.conv2d(
                  ...
                  weights_initializer=trunc_normal(0.09),
                  scope='Conv2d_0a_1x1')
              branch_2 = slim.conv2d(branch_2, depth(56), [3, 3],
                                     scope='Conv2d_0b_3x3')
              branch_2 = slim.conv2d(branch_2, depth(56), [3, 3],
                                     scope='Conv2d_0c_3x3')
