...
# --eval_dir: visualization result path

CUDA_VISIBLE_DEVICES=$1   python ./object_detection/eval.py \
--pipeline_config_path=./config/multi_branch_encoder_decoder_faster_rcnn_inception_v2_coco_dropout_l2regular_IOU_UPDATE_with_iou_loss_2x_random.config \
--checkpoint_dir=./result_random/ \
--eval_dir=./result_random/
