...
class FasterRCNNMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    self._first_stage_localization_loss = (
        losses.WeightedSmoothL1LocalizationPlusLoss())
  ...
  def _loss_rpn(self, rpn_box_encodings,
    ...
    with tf.name_scope('RPNLoss'):
      ...
      rpn_box_decodings = self._box_coder._decode(rpn_box_encodings, anchors)
      batch_reg_targets_decoded = self._box_coder._decode(batch_reg_targets, anchors)

      localization_losses = self._first_stage_localization_loss(
          rpn_box_encodings, batch_reg_targets, rpn_box_decodings, batch_reg_targets_decoded, weights=sampled_reg_indices)
